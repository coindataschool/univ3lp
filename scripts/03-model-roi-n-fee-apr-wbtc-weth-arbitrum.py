...
chain = 'arbitrum'
token0 = dict(
    symbol = 'wbtc', addr = '0x2f2a2543B76A4166549F7aaB2e75Bef0aefC5B0f')
token1 = dict(
...
price_lower_cutoff = 5 # lower limit of token0/token1 such as ETHGMX
price_upper_cutoff = 60 # upper limit of token0/token1 such as ETHGMX
